...
class CommoditiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commodity" do
    assert_difference("Commodity.count") do
      post commodities_url, params: { commodity: { name: @commodity.name, price: @commodity.price, quantity: @commodity.quantity } }
    end
  ...
  test "should update commodity" do
    patch commodity_url(@commodity), params: { commodity: { name: @commodity.name, price: @commodity.price, quantity: @commodity.quantity } }
